...
- Tables should always be responsive in width to the full widht of the browser
...
All amount, integerm number fields should be aligned to the right in tables and input forms and have norwegian amount formatting (space as thousand separator and comma as decimal separator)
