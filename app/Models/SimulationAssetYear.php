 ...
 * @property numeric-string|null $income_amount
 * @property string|null $income_factor
 * @property string|null $income_rule
 * @property string|null $income_transfer
 * @property numeric-string|null $income_transfer_amount
 * @property string|null $income_source
 * @property string|null $income_changerate
 * @property numeric-string|null $income_changerate_percent
 * @property bool $income_repeat
 * @property string|null $income_description
 * @property numeric-string|null $expence_amount
 * @property string|null $expence_factor
 * @property string|null $expence_rule
 * @property string|null $expence_transfer
 * @property numeric-string|null $expence_transfer_amount
 * @property string|null $expence_source
 * @property string|null $expence_changerate
 * @property numeric-string|null $expence_changerate_percent
 * @property bool $expence_repeat
 * @property string|null $expence_description
 * @property string|null $cashflow_description
 * @property numeric-string|null $cashflow_after_tax_amount
 * @property numeric-string|null $cashflow_before_tax_amount
 * @property numeric-string|null $cashflow_before_tax_aggregated_amount
 * @property numeric-string|null $cashflow_after_tax_aggregated_amount
 * @property numeric-string|null $cashflow_tax_amount
 * @property numeric-string|null $cashflow_tax_percent
 * @property string|null $cashflow_rule
 * @property string|null $cashflow_transfer
 * @property numeric-string|null $cashflow_transfer_amount
 * @property string|null $cashflow_source
 * @property string|null $cashflow_changerate
 * @property bool $cashflow_repeat
 * @property numeric-string|null $asset_market_amount
 * @property numeric-string|null $asset_market_mortgage_deducted_amount
 * @property numeric-string|null $asset_acquisition_amount
 * @property numeric-string|null $asset_acquisition_initial_amount
 * @property numeric-string|null $asset_equity_amount
 * @property numeric-string|null $asset_equity_initial_amount
 * @property numeric-string|null $asset_paid_amount
 * @property numeric-string|null $asset_paid_initial_amount
 * @property numeric-string|null $asset_transfered_amount
 * @property numeric-string|null $asset_taxable_percent
 * @property numeric-string|null $asset_taxable_amount
 * @property numeric-string|null $asset_taxable_initial_amount
 * @property bool $asset_taxable_amount_override
 * @property numeric-string|null $asset_tax_percent
 * @property numeric-string|null $asset_tax_amount
 * @property numeric-string|null $asset_taxable_property_percent
 * @property numeric-string|null $asset_taxable_property_amount
 * @property numeric-string|null $asset_tax_property_percent
 * @property numeric-string|null $asset_tax_property_amount
 * @property numeric-string|null $asset_taxable_fortune_amount
 * @property numeric-string|null $asset_taxable_fortune_percent
 * @property numeric-string|null $asset_tax_fortune_amount
 * @property numeric-string|null $asset_tax_fortune_percent
 * @property numeric-string|null $asset_gjeldsfradrag_amount
 * @property string|null $asset_changerate
 * @property numeric-string|null $asset_changerate_percent
 * @property string|null $asset_rule
 * @property string|null $asset_transfer
 * @property string|null $asset_source
 * @property bool $asset_repeat
 * @property string|null $asset_description
 * @property numeric-string|null $mortgage_amount
 * @property numeric-string|null $mortgage_term_amount
 * @property numeric-string|null $mortgage_interest_amount
 * @property numeric-string|null $mortgage_principal_amount
 * @property numeric-string|null $mortgage_balance_amount
 * @property numeric-string|null $mortgage_extra_downpayment_amount
 * @property numeric-string|null $mortgage_transfered_amount
 * @property numeric-string|null $mortgage_interest_percent
 * @property int|null $mortgage_years
 * @property int|null $mortgage_interest_only_years
 * @property numeric-string|null $mortgage_gebyr_amount
 * @property numeric-string|null $mortgage_tax_deductable_amount
 * @property numeric-string|null $mortgage_tax_deductable_percent
 * @property string|null $mortgage_description
 * @property string|null $realization_description
 * @property numeric-string|null $realization_amount
 * @property numeric-string|null $realization_taxable_amount
 * @property numeric-string|null $realization_tax_amount
 * @property numeric-string|null $realization_tax_percent
 * @property numeric-string|null $realization_tax_shield_amount
 * @property numeric-string|null $realization_tax_shield_percent
 * @property numeric-string|null $yield_gross_percent
 * @property numeric-string|null $yield_net_percent
 * @property numeric-string|null $yield_cap_percent
 * @property numeric-string|null $potential_income_amount
 * @property numeric-string|null $potential_mortgage_amount
 * @property numeric-string|null $metrics_roi_percent
 * @property numeric-string|null $metrics_total_return_amount
 * @property numeric-string|null $metrics_total_return_percent
 * @property numeric-string|null $metrics_coc_percent
 * @property numeric-string|null $metrics_noi
 * @property numeric-string|null $metrics_grm
 * @property numeric-string|null $metrics_dscr
 * @property numeric-string|null $metrics_ltv_percent
 * @property numeric-string|null $metrics_de_ratio
 * @property numeric-string|null $metrics_roe_percent
 * @property numeric-string|null $metrics_roa_percent
 * @property numeric-string|null $metrics_pb_ratio
 * @property numeric-string|null $metrics_ev_ebitda
 * @property numeric-string|null $metrics_current_ratio
 * @property numeric-string|null $fire_percent
 * @property numeric-string|null $fire_income_amount
 * @property numeric-string|null $fire_expence_amount
 * @property numeric-string|null $fire_cashflow_amount
 * @property numeric-string|null $fire_saving_amount
 * @property numeric-string|null $fire_saving_rate_percent
 ...
 * @property \App\Models\SimulationAsset|null $simulationAsset
 */
