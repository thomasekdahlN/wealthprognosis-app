...
class ChangeRateTable extends Page implements HasForms, HasTable
{
    ...
    public function getTitle(): string|Htmlable
    {
        ...
        $assetLabel = AssetType::query()->where('type', $this->asset)->value('name') ?? ucfirst($this->asset);
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('back_to_assets')
                ...
                ->color('gray')
                ->action(function () {
                    return redirect()->route('filament.system.pages.change-rate-assets', [
            ...
            Action::make('back_to_scenarios')
                ...
                ->color('gray')
                ->action(function () {
                    return redirect()->route('filament.system.pages.change-rate-scenarios');
                }),
        ];
    }
