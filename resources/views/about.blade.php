...
@section('description',
    'Why Wealth Prognosis exists, who builds it, and the principles behind the system.
    Privacy-first, accurate taxation and long-horizon planning.')
    ...
    {!! json_encode([
        ...
        '@graph' => [
            ...
            [
                ...
                'description' => 'Privacy-first financial planning and simulation system with accurate taxation.',
    ...
    @php
        $principles = [
            ...
            [
                ...
                'body' =>
                    'Every number on every page is traceable back to the rule that produced it. Tax configurations are versioned per year, change rates live on each asset, and the full simulation can be exported to Excel for review.',
            ],
            [
                'title' => 'Privacy-first',
                'body' =>
...
@section('content')
    ...
    <section class="relative hero-gradient overflow-hidden" aria-labelledby="about-title">
        ...
        <div class="relative max-w-4xl mx-auto px-6 lg:px-8 pt-12 pb-16 sm:pt-20 sm:pb-20 text-center">
            ...
            <h1 id="about-title" class="mt-6 text-4xl sm:text-6xl font-extrabold tracking-tight text-white leading-[1.05]">
            ...
            <p class="mt-6 text-lg sm:text-xl text-slate-300 leading-relaxed">
                ...
                accurate taxation, transparent calculations and three scenarios side by side.
            </p>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto px-6 lg:px-8 py-16 sm:py-20">
            ...
            <div class="mt-6 space-y-5 text-slate-300 leading-relaxed">
                <p>Personal finance software either stays so simple that it cannot answer real questions, or so complex
                    that only accountants can use it. Tax rules make this worse: fortune tax, property tax,
